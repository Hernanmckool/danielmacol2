            ...
            <ul class="nav navbar-nav">
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                          {!!Html::image('asset/dist/img/user3-128x128.jpg', 'User Image', array('class' => 'img-circle'))!!}
                          </div>
                          <h4>
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                          {!!Html::image('asset/dist/img/user4-128x128.jpg', 'User Image', array('class' => 'img-circle'))!!}
                          </div>
                          <h4>
                            Developers
              ...
              <li class="dropdown user user-menu">
                ...
                {!!Html::image('asset/dist/img/user2-160x160.jpg', 'User Image', array('class' => 'user-image'))!!}
                  <span class="hidden-xs">Hernan Perez
                  <!-- -->
                  </span>
                </a>
                <ul class="dropdown-menu">
